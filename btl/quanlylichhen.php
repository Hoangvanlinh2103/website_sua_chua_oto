...
<html>
    <head>
        ...
        <link rel="stylesheet" href="quanlykhachhang.css?v= <?php echo time(); ?>">
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <form action="timkieml.php?cid=1" method="POST">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>Thời gian</td>  
                            <td>Tình trạng</td>
                            <td><a class="a1" href="theml.html">Thêm</a></td>
                        </tr>
                    <?php    
                        ...
                        if ($action == "2") {
                            $mal=isset($_GET["mal"]) ? $_GET["mal"] :"";
                            if($mal != "") {
                                $success = Lich::Delete($mal);
                                if($success){
                    ...
                    ?>
                            <tr>
                                <td><?php echo $item->mal ?></td>
                                <td><?php echo $item->madv ?></td>
                                <td><?php echo $item->makh ?></td>
                                <td><?php echo $item->ngay ?></td>
                                <td><?php echo $item->tinhtrang ?></td>
                                <td>
                                    <a class="a1" href="editl.php?mal=<?php echo $item->mal ?>">Edit</a>
                                    <span class="a2"> | </span>
                                    <a class="a1" onclick="return confirm('Bạn có muốn xóa lịch hẹn?');"
                                    href="quanlylichhen.php?action=2&mal=<?php echo $item->mal ?>">Delete</a>
                                </td>
                            </tr>
                    <?php        
                        }
