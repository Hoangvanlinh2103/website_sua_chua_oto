    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                ...
                foreach($ds as $tim){
            ?>
                <form action="edit.php?cid=5" method="POST" id="them">
                    <input type="text" name="mal" id="makh" placeholder="Nhập mã lịch hẹn" value="<?php echo $tim->mal ?>" required readonly><br>
                    <input type="text" name="madv" id="tenkh" placeholder="Nhập mã dịch vụ" value="<?php echo $tim->madv ?>" required><br>
                    <input type="text" name="makh" id="dckh" placeholder="Nhập mã khách" value="<?php echo $tim->makh ?>" required><br>
                    <input type="text" name="ngay" id="dckh" placeholder="Nhập thời gian" value="<?php echo $tim->ngay ?>" required><br>
                    <input type="text" name="tt" id="dckh" placeholder="Nhập tình trạng" value="<?php echo $tim->tinhtrang ?>" required><br>
