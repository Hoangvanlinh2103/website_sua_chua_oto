    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                ...
                foreach($ds as $tim){
            ?>
                <form action="edit.php?cid=1&makhach=<?php echo $tim->makhach ?>" method="POST" id="them">
                    <input type="text" name="makh" id="makh" placeholder="Nhập mã khách" value="<?php echo $tim->makhach ?>" required readonly><br>
                    <input type="text" name="tenkh" id="tenkh" placeholder="Nhập tên khách" value="<?php echo $tim->tenkhach ?>" required><br>
                    <input type="text" name="dckh" id="dckh" placeholder="Nhập địa chỉ khách hàng" value="<?php echo $tim->diachikh ?>" required><br>
                    <input type="text" name="gtkh" id="gtkh" placeholder="Nhập giới tính" value="<?php echo $tim->gioitinh ?>" required><br>
                    <input type="text" name="sdtkh" id="sdtkh" placeholder="Nhập số điện thoại" value="<?php echo $tim->sodienthoai?>" required><br> 
