...
<html>
    <head>
        ...
        <link rel="stylesheet" href="quanlydichvu.css?v= <?php echo time(); ?>">
    </head>
    <body>
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td>Tên dịch vụ</td>
                                <td>Loại dịch vụ</td>
                                <td><a class="a1" href="themdv.html">Thêm</a></td>
                            </tr>
                        <?php    
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $item->loaidv ?></td>
                                    <td>
                                        <a class="a1" href="editdv.php?madv=<?php echo $item->madv ?>">Edit</a>
                                        <span class="a2"> | </span>
                                        <a class="a1" onclick="return confirm('Bạn có muốn xóa dịch vụ?');"
                                        href="quanlydichvu.php?action=2&madv=<?php echo $item->madv ?>">Delete</a>
                                    </td>
                                </tr>
                        <?php        
                            }
