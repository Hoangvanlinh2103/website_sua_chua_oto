...
<html>
    <head>
        ...
        <link rel="stylesheet" href="quanlyphukien.css?v= <?php echo time(); ?>">
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <form action="timkiempk.php?cid=1" method="POST">
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td>Số lượng</td>  
                                <td>Giá</td>
                                <td><a class="a1" href="thempk.html">Thêm</a></td>
                            </tr>
                        <?php    
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><img style="width:100px" src="anh/<?php echo $item->anh ?>"></td>
                                    <td><?php echo $item->loaipk ?></td>
                                    <td><?php echo $item->soluongpk ?></td>
                                    <td><?php echo $item->giapk ?></td>
                                    <td>
                                        <a class="a1" href="editpk.php?mapk=<?php echo $item->mapk ?>">Edit</a>
                                        <span class="a2"> | </span>
                                        <a class="a1" onclick="return confirm('Bạn có muốn xóa phụ kiện?');"
                                        href="quanlyphukien.php?action=2&mapk=<?php echo $item->mapk ?>">Delete</a>
                                    </td>
                                </tr>
                        <?php        
                            }
